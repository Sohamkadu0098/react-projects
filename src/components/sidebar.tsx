...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 p-5 h-full">
     <h2 className='text-9xl font-bold mb-10 mt-4'>React Stores
     </h2>
     ...
     <div className='mb-5 mt-4'>
      ...
      <div>
        {keywords.map((keyword,index) =>(
          <button key={index} className='block mb-2 px-4  py-2 w-full text-left border rounded hover:bg-grey-200'
